            ...
            <div class="bg-white shadow-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ($vacantes as $vacante )
                    <div class="md:flex md:justify-between md:items-center py-5">
                          <div class="md:flex-1">
                                   <a
                                   class="font-extrabold text-xl text-gray-600"
                                   href="{{route('vacantes.show',$vacante->id)}}"
                                    >
                                    {{$vacante->titulo}}
                                     </a>
                                     <p class=" font-bold text-base text-gray-600 mb-1">
                                        {{$vacante->empresa}}
                ...
                @empty
                     <p class="p-3 text-center text-gray-600 text-sm">No hay vacantes publicadas aún</p>
                @endforelse
            </div>
      </div>
</div>
